...
const Landing = () => {
  ...
  const plans = [
    { id: 'core-access', name: "Core Access", price: "$49", features: ["Essential Programs", "Basic Nutrition Guide", "Community Access"], highlight: false },
    { id: 'pro-elite', name: "Pro Elite", price: "$99", features: ["All Core Access", "1:1 Coaching Session (Monthly)", "Advanced Bio-Tracking", "Priority Support"], highlight: true },
  ];
